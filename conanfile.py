...
class ProjectionExplorerView(ConanFile):
    ...
    name = "ProjectionExplorer"
    description = """Scatterplot view that provides additional explanatory visualizations for data projections."""
    topics = ("manivault", "plugin", "view", "projection", "explanation")
    url = "https://github.com/ManiVaultStudio/ProjectionExplorer"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/ProjectionExplorer",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/ProjectionExplorer")
        cmake.verbose = True
        return cmake
