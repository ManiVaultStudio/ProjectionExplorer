...
class ProjectionExplorerConan(ConanFile):
    ...
    description = """View plugin for analysing embeddings based on salient features."""
    topics = ("manivault", "plugin", "view", "projection")
